...
import { Package, ShoppingCart, LayoutDashboard, ReceiptText, Tags, Gift } from "lucide-react";
...
const navItems = [
  ...
  { href: "/dashboard/gift-cards", label: "Gift", icon: Gift },
  { href: "/dashboard/facturacion", label: "Fact.", icon: ReceiptText },
